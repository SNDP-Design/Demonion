...
interface DemonierLogoProps {
  className?: string;
}

export const DemonierLogo: React.FC<DemonierLogoProps> = ({ className }) => (
  <svg className={className} width="18" height="18" viewBox="0 0 48 48" aria-hidden="true" focusable="false">
    ...
    <path d="M15 11h10.6C34 11 40 16.5 40 24s-6 13-14.4 13H15V11Z" fill="url(#demonier-logo-fill)" />
    ...
    <defs>
      <linearGradient id="demonier-logo-fill" x1="12.3" y1="11" x2="39" y2="37.8" gradientUnits="userSpaceOnUse">
