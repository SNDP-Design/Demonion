  ...
  return (
    <main className="framer-landing" id="home">
      <section className="framer-hero">
        ...
        <div className="framer-product-shell" aria-label="Interactive Demonier preview">
          <div className="framer-product-top"><div className="framer-dots"><i /><i /><i /></div><span>Demonier Studio</span><small>● Ready to record</small></div>
      ...
      <section className="framer-intro" id="features"><span className="framer-kicker">Everything you need. Nothing to learn.</span><h3>From first click to<br /><em>ready-to-share.</em></h3><p>Demonier turns the usual pile of recording tools into one focused flow.</p></section>
